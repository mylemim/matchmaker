...
public class SessionControllerTest {
    ...
    @Test
    public void createSessionWithParticipant() throws Exception {
        final String testSessionName = "testName";

        Participant participant = new Participant("participant_name");
        participant = participantRepository.save(participant);

        Session session = new Session(testSessionName);
        session.addParticipant(participant);

        String a = mapper.writeValueAsString(session);
